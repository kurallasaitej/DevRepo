    ...
    public class Logger : SingletonBase<Logger>
    {
        ...
        private Logger()
        {
            ...
            if (hier != null)
            {
                ...
                if (adoAppender != null)
                {
                    adoAppender.ConnectionString = ConfigurationManager.ConnectionStrings["PEConnection"].ToString();
                        //@"data source=(local)\SQLExpress;Initial Catalog=NHibernateSimpleDemo;integrated security=false;persist security info=True;User ID=sa;Password=sriram";
