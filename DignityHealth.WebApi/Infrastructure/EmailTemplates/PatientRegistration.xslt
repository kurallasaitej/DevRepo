  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <p>Hello!</p>
        <p>
          Thank you for creating an account with <xsl:value-of select="EmailParameters/ApplicationName"/>. We look forward to helping support you and improve the quality of your healthcare experience.
        </p>
        <p>
          <b>
